...
export default function IconComponent({ weatherCode, x, className }: IconComponentProps) {
  ...
  return (
    <div className={`relative invert-0 dark:invert ${className}`}>
      <Image fill alt={weatherCode} src={`/icons/wi-${iconName}.svg`} className="select-none" />
    </div>
  );
}
